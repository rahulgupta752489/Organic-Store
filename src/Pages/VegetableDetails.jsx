...
export const VegetableDetails = () => {
    ...
    useEffect(() => {
        axios.get(`https://online-store-quc3.onrender.com/vegetables/${id}`).then((res) => {
            setVeg(res.data);
        }).catch((err) => {
            console.log(err);
        })
    ...
    const { category, image, description, price_inr, title, discount_percentage, discount_price_inr, ETA } = veg;
