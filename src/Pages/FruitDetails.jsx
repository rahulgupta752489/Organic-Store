...
export const FruitDetails = () => {
    ...
    useEffect(() => {
        axios.get(`https://online-store-quc3.onrender.com/fruits/${id}`).then((res) => {
            setFruit(res.data);
        }).catch((err) => {
            console.log(err);
        })
    ...
    const { category, image, description, price_inr, title, discount_percentage, discount_price_inr, ETA } = fruit;
